...
import fr.isen.perucca.androiderestaurant.databinding.ViewBasketBinding

import fr.isen.perucca.androiderestaurant.model.BasketData


class BasketAdapter(private val dishes: List<BasketData>) :
    RecyclerView.Adapter<BasketAdapter.BasketViewHolder>() {

    class BasketViewHolder(private val binding: ViewBasketBinding) :
